...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    if (cart) {
      // Find the product in the cart based on the productId, size, and color
      ...
      // If no cart exists, create a new cart for guest or user
...
//@route GET /api/cart
//@desc get logged in or guest user carts
//@access public
...
//@desc Merge guest cart into user cart for login
//@access Private
router.post("/merge", protect, async (req, res) => {
  ...
  try {
    ...
    if (guestCart) {
      ...
      if (userCart) {
        //Guest cart has alreafy been merged, return user cart
